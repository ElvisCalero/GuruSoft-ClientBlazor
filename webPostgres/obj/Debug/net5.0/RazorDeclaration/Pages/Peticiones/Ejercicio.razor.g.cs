...
#nullable disable
    ...
    public partial class Ejercicio : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 14 "C:\Users\59399\source\repos\ElvisCalero\IntiSoluciones-webPostgres\webPostgres\Pages\Peticiones\Ejercicio.razor"
       
    Peticion entity { get; set; } = new();

    async Task Create()
    {
        entity.Fecha_Request = DateTime.Now;
        await Http.PostAsJsonAsync("https://localhost:44392/api/Peticion", entity);
